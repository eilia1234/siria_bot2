...
async def siriabot(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    system_prompt = {
        ...
        "content": (
            ...
            "هر فردی را که نمیسناسی پاسخ نده که شاعر است یا بازیگر است اگر اطلاعات دقیق و درست داری پاسخ بده اگر اطلاعاتی درباره آن فرد نداری پاسخ بده اطلاعاتی درباره آن ندارم."
            ...
            "تو باید به تمامی سوالات پاسخ بدهی."
        )
    }
